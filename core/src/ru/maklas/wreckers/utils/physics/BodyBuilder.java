package ru.maklas.wreckers.utils.physics;
...
public class BodyBuilder {
	...
	private final Array<FixtureData> fDatas = new Array<>();
	...
	public BodyBuilder addFixture(FixtureDef fDef){
		addFixture(fDef, null);
		return this;
	}

	public BodyBuilder addFixture(FixtureDef fDef, FixtureData fData){
		fixDefs.add(fDef);
		fDatas.add(fData);
		return this;
	}
	...
	public Body build(){
		...
		for (int i = 0; i < size; i++) {
			...
			fixture.setUserData(fDatas.get(i));
