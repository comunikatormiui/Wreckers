...
public class StringUtils {
	...
	public static String componentToString(@NotNull Component c){
		if (implementsToString(c.getClass())){
			return c.toString();
		} else {
	...
	public static boolean implementsToString(Class<?> c){
		Class<?> toStringImplClass;
		try {
			toStringImplClass = c.getMethod("toString").getDeclaringClass();
		} catch (Throwable e) {
			return false;
		}
	...
	/**
	 * Checks if class of the object implements {@link #toString()} method.
	 * Uses it if it does implement. Otherwise tries to access the fields and make it
	 */
	...
	/**
	 * Does not add class name before {}
	 * @param checkToString Check if class of the object implements
	 * {@link #toString} method and use it if it does
	 */
	public static String objectToString(Object o, boolean checkToString){
		if (o == null) return "null";
		if (checkToString && implementsToString(o.getClass())){
			return o.toString();
		}
	   return objectToStringNoClassName(o);
	}
